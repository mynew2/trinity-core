...
INSERT INTO `command` VALUES ('additem', '10', 'Syntax: .additem #itemid/[#itemname]/#shift-click-item-link #itemcount\r\n\r\nAdds the specified number of items of id #itemid (or exact (!) name $itemname in brackets, or link created by shift-click at item in inventory or recipe) to your or selected character inventory. If #itemcount is omitted, only one item will be added.\r\n.');
INSERT INTO `command` VALUES ('additemset', '10', 'Syntax: .additemset #itemsetid\r\n\r\nAdd items from itemset of id #itemsetid to your or selected character inventory. Will add by one example each item from itemset.');
INSERT INTO `command` VALUES ('announce', '462', 'Syntax: .announce $MessageToBroadcast\r\n\r\nSend a global message to all players online in chat log.');
INSERT INTO `command` VALUES ('aura', '10', 'Syntax: .aura #spellid\r\n\r\nAdd the aura from spell #spellid to the selected Unit.');
...
INSERT INTO `command` VALUES ('bank', '10', 'Syntax: .bank\r\n\r\nShow your bank inventory.');
...
INSERT INTO `command` VALUES ('bindsight', '10', 'Syntax: .bindsight\r\n\r\nBinds vision to the selected unit indefinitely. Cannot be used while currently possessing a target.');
INSERT INTO `command` VALUES ('cast back', '264', 'Syntax: .cast back #spellid [triggered]\r\n  Selected target will cast #spellid to your character. If \'trigered\' or part provided then spell casted with triggered flag.');
INSERT INTO `command` VALUES ('cast dist', '265', 'Syntax: .cast dist #spellid [#dist [triggered]]\r\n  You will cast spell to pint at distance #dist. If \'trigered\' or part provided then spell casted with triggered flag. Not all spells can be casted as area spells.');
INSERT INTO `command` VALUES ('cast self', '266', 'Syntax: .cast self #spellid [triggered]\r\nCast #spellid by target at target itself. If \'trigered\' or part provided then spell casted with triggered flag.');
INSERT INTO `command` VALUES ('cast target', '267', 'Syntax: .cast target #spellid [triggered]\r\n  Selected target will cast #spellid to his victim. If \'trigered\' or part provided then spell casted with triggered flag.');
INSERT INTO `command` VALUES ('cast', '263', 'Syntax: .cast #spellid [triggered]\r\n  Cast #spellid to selected target. If no target selected cast to self. If \'trigered\' or part provided then spell casted with triggered flag.');
...
INSERT INTO `command` VALUES ('debug play cinematic', '8', 'Syntax: .debug play cinematic #cinematicid\r\n\r\nPlay cinematic #cinematicid for you. You stay at place while your mind fly.\r\n');
...
INSERT INTO `command` VALUES ('demorph', '9', 'Syntax: .demorph\r\n\r\nDemorph the selected player.');
INSERT INTO `command` VALUES ('die', '10', 'Syntax: .die\r\n\r\nKill the selected player. If no player is selected, it will kill you.');
INSERT INTO `command` VALUES ('dismount', '7', 'Syntax: .dismount\r\n\r\nDismount you, if you are mounted.');
INSERT INTO `command` VALUES ('distance', '10', 'Syntax: .distance\r\n\r\nDisplay the distance from your character to the selected creature.');
...
INSERT INTO `command` VALUES ('cheat cooldown', '0', 'Syntax: .cheat cooldown [on/off]\r\nEnables or disables your character\'s spell cooldowns.');
INSERT INTO `command` VALUES ('cheat power', '0', 'Syntax: .cheat power [on/off]\r\nEnables or disables your character\'s spell cost (e.g mana).');
INSERT INTO `command` VALUES ('flusharenapoints', '10', 'Syntax: .flusharenapoints\r\n\r\nUse it to distribute arena points based on arena team ratings, and start a new week.');
INSERT INTO `command` VALUES ('freeze', '8', 'Syntax: .freeze (#player)\r\n\"Freezes\" #player and disables his chat. When using this without #name it will freeze your target.');
...
INSERT INTO `command` VALUES ('go creature', '372', 'Syntax: .go creature #creature_guid\r\nTeleport your character to creature with guid #creature_guid.\r\n.gocreature #creature_name\r\nTeleport your character to creature with this name.\r\n.gocreature id #creature_id\r\nTeleport your character to a creature that was spawned from the template with this entry.\r\n*If* more than one creature is found, then you are teleported to the first that is found inside the database.');
INSERT INTO `command` VALUES ('go graveyard', '373', 'Syntax: .go graveyard #graveyardId\r\n Teleport to graveyard with the graveyardId specified.');
INSERT INTO `command` VALUES ('go grid', '374', 'Syntax: .go grid #gridX #gridY [#mapId]\r\n\r\nTeleport the gm to center of grid with provided indexes at map #mapId (or current map if it not provided).');
INSERT INTO `command` VALUES ('go object', '375', 'Syntax: .go object #object_guid\r\nTeleport your character to gameobject with guid #object_guid');
INSERT INTO `command` VALUES ('go taxinode', '376', 'Syntax: .go taxinode #taxinode\r\n\r\nTeleport player to taxinode coordinates. You can look up zone using .lookup taxinode $namepart');
...
INSERT INTO `command` VALUES ('go trigger', '378', 'Syntax: .go trigger #trigger_id\r\n\r\nTeleport your character to areatrigger with id #trigger_id. Character will be teleported to trigger target if selected areatrigger is telporting trigger.');
INSERT INTO `command` VALUES ('go xyz', '379', 'Syntax: .go xyz #x #y [#z [#mapid [#orientation]]]\r\n\r\nTeleport player to point with (#x,#y,#z) coordinates at map #mapid with orientation #orientation. If z is not provided, ground/water level will be used. If mapid is not provided, the current map will be used. If #orientation is not provided, the current orientation will be used.');
INSERT INTO `command` VALUES ('go zonexy', '380', 'Syntax: .go zonexy #x #y [#zone]\r\n\r\nTeleport player to point with (#x,#y) client coordinates at ground(water) level in zone #zoneid or current zone if #zoneid not provided. You can look up zone using .lookup area $namepart');
INSERT INTO `command` VALUES ('go', '371', 'Syntax: .go $subcommand\nType .go to see the list of possible subcommands or .help go $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('gobject activate', '372', 'Syntax: .gobject activate #guid\r\n\r\nActivates an object like a door or a button.');
INSERT INTO `command` VALUES ('gobject add', '373', 'Syntax: .gobject add #id <spawntimeSecs>\r\n\r\nAdd a game object from game object templates to the world at your current location using the #id.\r\nspawntimesecs sets the spawntime, it is optional.\r\n\r\nNote: this is a copy of .gameobject.');
INSERT INTO `command` VALUES ('gobject delete', '375', 'Syntax: .gobject delete #go_guid\r\nDelete gameobject with guid #go_guid.');
INSERT INTO `command` VALUES ('gobject move', '377', 'Syntax: .gobject move #goguid [#x #y #z]\r\n\r\nMove gameobject #goguid to character coordinates (or to (#x,#y,#z) coordinates if its provide).');
INSERT INTO `command` VALUES ('gobject near', '378', 'Syntax: .gobject near  [#distance]\r\n\r\nOutput gameobjects at distance #distance from player. Output gameobject guids and coordinates sorted by distance from character. If #distance not provided use 10 as default value.');
INSERT INTO `command` VALUES ('gobject add temp', '374', 'Adds a temporary gameobject that is not saved to DB.');
INSERT INTO `command` VALUES ('gobject target', '382', 'Syntax: .gobject target [#go_id|#go_name_part]\r\n\r\nLocate and show position nearest gameobject. If #go_id or #go_name_part provide then locate and show position of nearest gameobject with gameobject template id #go_id or name included #go_name_part as part.');
INSERT INTO `command` VALUES ('gobject set phase', '380', 'Syntax: .gobject set phase #guid #phasemask\r\n\r\nGameobject with DB guid #guid phasemask changed to #phasemask with related world vision update for players. Gameobject state saved to DB and persistent.');
INSERT INTO `command` VALUES ('gobject turn', '383', 'Syntax: .gobject turn #goguid \r\n\r\nSet for gameobject #goguid orientation same as current character orientation.');
INSERT INTO `command` VALUES ('gobject', '371', 'Syntax: .gobject $subcommand\nType .gobject to see the list of possible subcommands or .help gobject $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('summon', '8', 'Syntax: .summon [$charactername]\r\n\r\nTeleport the given character to you. Character can be offline.');
INSERT INTO `command` VALUES ('gps', '8', 'Syntax: .gps [$name|$shift-link]\r\n\r\nDisplay the position information for a selected character or creature (also if player name $name provided then for named player, or if creature/gameobject shift-link provided then pointed creature/gameobject if it loaded). Position information includes X, Y, Z, and orientation, map Id and zone Id');
INSERT INTO `command` VALUES ('groupsummon', '8', 'Syntax: .groupsummon [$charactername]\r\n\r\nTeleport the given character and his group to you. Teleported only online characters but original selected group member can be offline.');
INSERT INTO `command` VALUES ('guid', '9', 'Syntax: .guid\r\n\r\nDisplay the GUID for the selected character.');
...
INSERT INTO `command` VALUES ('help', '7', 'Syntax: .help [$command]\r\n\r\nDisplay usage instructions for the given $command. If no $command provided show list available commands.');
INSERT INTO `command` VALUES ('hidearea', '10', 'Syntax: .hidearea #areaid\r\n\r\nHide the area of #areaid to the selected character. If no character is selected, hide this area to you.');
...
INSERT INTO `command` VALUES ('modify talentpoints', '8', 'Syntax: .modify talentpoints #amount\r\n\r\nSet free talent points for selected character or character\'s pet. It will be reset to default expected at next levelup/login/quest reward.');
INSERT INTO `command` VALUES ('instance listbinds', '409', 'Syntax: .instance listbinds\r\n  Lists the binds of the selected player.');
INSERT INTO `command` VALUES ('instance savedata', '411', 'Syntax: .instance savedata\r\n  Save the InstanceData for the current player\'s map to the DB.');
INSERT INTO `command` VALUES ('instance stats', '411', 'Syntax: .instance stats\r\n  Shows statistics about instances.');
INSERT INTO `command` VALUES ('instance unbind', '410', 'Syntax: .instance unbind <mapid|all> [difficulty]\r\n  Clear all/some of player\'s binds');
INSERT INTO `command` VALUES ('instance', '408', 'Syntax: .instance $subcommand\nType .instance to see the list of possible subcommands or .help instance $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('itemmove', '9', 'Syntax: .itemmove #sourceslotid #destinationslotid\r\n\r\nMove an item from slots #sourceslotid to #destinationslotid in your inventory\r\n\r\nNot yet implemented');
INSERT INTO `command` VALUES ('kick', '9', 'Syntax: .kick [$charactername] [$reason]\r\n\r\nKick the given character name from the world with or without reason. If no character name is provided then the selected player (except for yourself) will be kicked. If no reason is provided, default is \"No Reason\".');
...
INSERT INTO `command` VALUES ('linkgrave', '10', 'Syntax: .linkgrave #graveyard_id [alliance|horde]\r\n\r\nLink current zone to graveyard for any (or alliance/horde faction ghosts). This let character ghost from zone teleport to graveyard after die if graveyard is nearest from linked to zone and accept ghost of this faction. Add only single graveyard at another map and only if no graveyards linked (or planned linked at same map).');
...
INSERT INTO `command` VALUES ('listfreeze', '8', 'Syntax: .listfreeze\r\n\r\nSearch and output all frozen players.');
INSERT INTO `command` VALUES ('wp reload', '10', 'Syntax: .wp reload $pathid\nLoad path changes ingame - IMPORTANT: must be applied first for new paths before .wp load #pathid ');
INSERT INTO `command` VALUES ('reload spell_group', '10', 'Syntax: .reload spell_group\nReload spell_group table.');
...
INSERT INTO `command` VALUES ('maxskill', '10', 'Syntax: .maxskill\r\nSets all skills of the targeted player to their maximum values for its current level.');
INSERT INTO `command` VALUES ('modify speed walk', '8', 'Syntax: .modify speed bwalk #rate\r\n\r\nModify the speed of the selected player while running to \"normal walk speed\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
INSERT INTO `command` VALUES ('modify bit', '8', 'Syntax: .modify bit #field #bit\r\n\r\nToggle the #bit bit of the #field field for the selected player. If no player is selected, modify your character.');
INSERT INTO `command` VALUES ('modify speed swim', '8', 'Syntax: .modify speed swim #rate\r\n\r\nModify the swim speed of the selected player to \"normal swim speed\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
INSERT INTO `command` VALUES ('modify drunk', '8', 'Syntax: .modify drunk #value\r\n Set drunk level to #value (0..100). Value 0 remove drunk state, 100 is max drunked state.');
INSERT INTO `command` VALUES ('modify energy', '8', 'Syntax: .modify energy #energy\r\n\r\nModify the energy of the selected player. If no player is selected, modify your energy.');
INSERT INTO `command` VALUES ('modify faction', '8', 'Syntax: .modify faction #factionid #flagid #npcflagid #dynamicflagid\r\n\r\nModify the faction and flags of the selected creature. Without arguments, display the faction and flags of the selected creature.');
INSERT INTO `command` VALUES ('modify speed fly', '8', '.modify speed fly #rate\nModify the flying speed of the selected player to \"normal flying speed\"*rate. If no player is selected, modify your speed.\n #rate may range from 0.1 to 50.');
INSERT INTO `command` VALUES ('modify gender', '9', 'Syntax: .modify gender male/female\r\n\r\nChange gender of selected player.');
INSERT INTO `command` VALUES ('modify honor', '8', 'Syntax: .modify honor $amount\r\n\r\nAdd $amount honor points to the selected player.');
INSERT INTO `command` VALUES ('modify hp', '8', 'Syntax: .modify hp #newhp\r\n\r\nModify the hp of the selected player. If no player is selected, modify your hp.');
INSERT INTO `command` VALUES ('modify mana', '8', 'Syntax: .modify mana #newmana\r\n\r\nModify the mana of the selected player. If no player is selected, modify your mana.');
INSERT INTO `command` VALUES ('modify money', '8', 'Syntax: .modify money #money\r\n.money #money\r\n\r\nAdd or remove money to the selected player. If no player is selected, modify your money.\r\n\r\n #gold can be negative to remove money.');
INSERT INTO `command` VALUES ('modify mount', '8', 'Syntax: .modify mount #id #speed\r\nDisplay selected player as mounted at #id creature and set speed to #speed value.');
INSERT INTO `command` VALUES ('modify phase', '10', 'Syntax: .modify phase #phasemask\r\n\r\nSelected character phasemask changed to #phasemask with related world vision update. Change active until in game phase changed, or GM-mode enable/disable, or re-login. Character pts pasemask update to same value.');
INSERT INTO `command` VALUES ('modify rage', '8', 'Syntax: .modify rage #newrage\r\n\r\nModify the rage of the selected player. If no player is selected, modify your rage.');
INSERT INTO `command` VALUES ('modify reputation', '9', 'Syntax: .modify reputation #repId (#repvalue | $rankname [#delta])\nSets the selected players reputation with faction #repId to #repvalue or to $reprank.\nIf the reputation rank name is provided, the resulting reputation will be the lowest reputation for that rank plus the delta amount, if specified.\nYou can use \'.pinfo rep\' to list all known reputation ids, or use \'.lookup faction $name\' to locate a specific faction id.');
INSERT INTO `command` VALUES ('modify runicpower', '8', 'Syntax: .modify runicpower #newrunicpower\r\n\r\nModify the runic power of the selected player. If no player is selected, modify your runic power.');
INSERT INTO `command` VALUES ('modify speed', '8', 'Syntax: .modify speed $speedtype #rate\r\n\r\nModify the running speed of the selected player to \"normal base run speed\"= 1. If no player is selected, modify your speed.\r\n\r\n$speedtypes may be fly, all, walk, backwalk, or swim.\r\n\r\n #rate may range from 0.1 to 50.');
INSERT INTO `command` VALUES ('modify spell', '8', 'TODO');
INSERT INTO `command` VALUES ('modify standstate', '9', 'Syntax: .modify standstate #emoteid\r\n\r\nChange the emote of your character while standing to #emoteid.');
INSERT INTO `command` VALUES ('modify speed backwalk', '8', 'Syntax: .modify speed backwalk #rate\r\n\r\nModify the speed of the selected player while running backwards to \"normal walk back speed\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
...
INSERT INTO `command` VALUES ('modify speed all', '8', 'Syntax: .modify aspeed #rate\r\n\r\nModify all speeds -run,swim,run back,swim back- of the selected player to \"normalbase speed for this move type\"*rate. If no player is selected, modify your speed.\r\n\r\n #rate may range from 0.1 to 50.');
INSERT INTO `command` VALUES ('modify', '8', 'Syntax: .modify $subcommand\nType .modify to see the list of possible subcommands or .help modify $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('movegens', '10', 'Syntax: .movegens\r\n  Show movement generators stack for selected creature or player.');
INSERT INTO `command` VALUES ('mute', '8', 'Syntax: .mute [$playerName] $timeInMinutes [$reason]\r\n\r\nDisible chat messaging for any character from account of character $playerName (or currently selected) at $timeInMinutes minutes. Player can be offline.');
...
INSERT INTO `command` VALUES ('npc say', '8', 'Syntax: .npc say $message\nMake selected creature say specified message.');
INSERT INTO `command` VALUES ('npc move', '9', 'Syntax: .npc move [#creature_guid]\r\n\r\nMove the targeted creature spawn point to your coordinates.');
INSERT INTO `command` VALUES ('npc playemote', '10', 'Syntax: .npc playemote #emoteid\r\n\r\nMake the selected creature emote with an emote of id #emoteid.');
INSERT INTO `command` VALUES ('npc follow stop', '9', 'Syntax: .npc follow stop\r\n\r\nSelected creature (non pet) stop follow you.');
INSERT INTO `command` VALUES ('npc info', '10', 'Syntax: .npc info\r\n\r\nDisplay a list of details for the selected creature.\r\n\r\nThe list includes:\r\n- GUID, Faction, NPC flags, Entry ID, Model ID,\r\n- Level,\r\n- Health (current/maximum),\r\n\r\n- Field flags, dynamic flags, faction template, \r\n- Position information,\r\n- and the creature type, e.g. if the creature is a vendor.');
INSERT INTO `command` VALUES ('npc follow', '9', 'Syntax: .npc follow start\r\n\r\nSelected creature start follow you until death/fight/etc.');
INSERT INTO `command` VALUES ('npc set flag', '9', 'Syntax: .npc set flag #npcflag\r\n\r\nSet the NPC flags of creature template of the selected creature and selected creature to #npcflag. NPC flags will applied to all creatures of selected creature template after server restart or grid unload/load.');
INSERT INTO `command` VALUES ('npc set factionid', '9', 'Syntax: .npc set factionid #factionid\r\n\r\nSet the faction of the selected creature to #factionid.');
INSERT INTO `command` VALUES ('npc set level', '9', 'Syntax: .npc set level #level\r\n\r\nChange the level of the selected creature to #level.\r\n\r\n#level may range from 1 to (CONFIG_MAX_PLAYER_LEVEL) + 3.');
INSERT INTO `command` VALUES ('npc delete', '9', 'Syntax: .npc delete [#guid]\r\n\r\nDelete creature with guid #guid (or the selected if no guid is provided)');
INSERT INTO `command` VALUES ('npc delete item', '9', 'Syntax: .npc delete item #itemId\r\n\r\nRemove item #itemid from item list of selected vendor.');
INSERT INTO `command` VALUES ('npc set allowmove', '10', 'Syntax: .npc set allowmove\r\n\r\nEnable or disable movement creatures in world. Not implemented.');
INSERT INTO `command` VALUES ('npc set entry', '10', 'Syntax: .npc set entry $entry\nSwitch selected creature with another entry from creature_template. - New creature.id value not saved to DB.');
INSERT INTO `command` VALUES ('npc add move', '9', 'Syntax: .npc add move #creature_guid [#waittime]\r\n\r\nAdd your current location as a waypoint for creature with guid #creature_guid. And optional add wait time.');
INSERT INTO `command` VALUES ('npc add item', '9', 'Syntax: .npc add item #itemId <#maxcount><#incrtime><#extendedcost>r\r\n\r\nAdd item #itemid to item list of selected vendor. Also optionally set max count item in vendor item list and time to item count restoring and items ExtendedCost.');
INSERT INTO `command` VALUES ('npc add formation', '8', 'Syntax: .npc add formation $leader\nAdd selected creature to a leader\'s formation.');
INSERT INTO `command` VALUES ('npc', '8', 'Syntax: .npc $subcommand\nType .npc to see the list of possible subcommands or .help npc $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('npc add', '9', 'Syntax: .npc add #creatureid\r\n\r\nSpawn a creature by the given template id of #creatureid.');
...
INSERT INTO `command` VALUES ('pet create', '9', 'Syntax: .pet create\r\n\r\nCreates a pet of the selected creature.');
INSERT INTO `command` VALUES ('pet learn', '9', 'Syntax: .pet learn\r\n\r\nLearn #spellid to pet.');
INSERT INTO `command` VALUES ('reload spell_proc', '10', 'Syntax: .reload spell_proc\nReload spell_proc table.');
INSERT INTO `command` VALUES ('pet unlearn', '9', 'Syntax: .pet unlean\r\n\r\nunLearn #spellid to pet.');
INSERT INTO `command` VALUES ('pet', '9', 'Syntax: .pet $subcommand\nType .pet to see the list of possible subcommands or .help pet $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('pinfo', '9', 'Syntax: .pinfo [$player_name/#GUID]\r\n\r\nOutput account information and guild information for selected player or player find by $player_name or #GUID.');
INSERT INTO `command` VALUES ('playall', '9', 'Syntax: .playall #soundid\r\n\r\nPlayer a sound to whole server.');
INSERT INTO `command` VALUES ('possess', '10', 'Syntax: .possess\r\n\r\nPossesses indefinitely the selected creature.');
INSERT INTO `command` VALUES ('quest add', '10', 'Syntax: .quest add #quest_id\r\n\r\nAdd to character quest log quest #quest_id. Quest started from item can\'t be added by this command but correct .additem call provided in command output.');
INSERT INTO `command` VALUES ('quest complete', '10', 'Syntax: .quest complete #questid\r\nMark all quest objectives as completed for target character active quest. After this target character can go and get quest reward.');
INSERT INTO `command` VALUES ('quest remove', '10', 'Syntax: .quest remove #quest_id\r\n\r\nSet quest #quest_id state to not completed and not active (and remove from active quest list) for selected player.');
INSERT INTO `command` VALUES ('quest', '10', 'Syntax: .quest $subcommand\nType .quest to see the list of possible subcommands or .help quest $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('recall', '8', 'Syntax: .recall [$playername]\r\n\r\nTeleport $playername or selected player to the place where he has been before last use of a teleportation command. If no $playername is entered and no player is selected, it will teleport you.');
INSERT INTO `command` VALUES ('reload all quest', '10', 'Syntax: .reload all quest\r\n\r\nReload all quest related tables if reload support added for this table and this table can be _safe_ reloaded.');
INSERT INTO `command` VALUES ('reload all npc', '10', 'Syntax: .reload all npc\nReload npc_option, npc_trainer, npc vendor, points of interest tables.');
INSERT INTO `command` VALUES ('reload all loot', '10', 'Syntax: .reload all loot\r\n\r\nReload all `*_loot_template` tables. This can be slow operation with lags for server run.');
INSERT INTO `command` VALUES ('reload all item', '10', 'Syntax: .reload all item\nReload page_text, item_enchantment_table tables.');
INSERT INTO `command` VALUES ('reload all locales', '10', 'Syntax: .reload all locales\r\n\r\nReload all `locales_*` tables with reload support added and that can be _safe_ reloaded.');
INSERT INTO `command` VALUES ('reload all gossips', '10', 'Syntax: .reload all gossips\nReload gossip_menu, gossip_menu_option, gossip_scripts, points_of_interest tables.');
INSERT INTO `command` VALUES ('reload all', '10', 'Syntax: .reload all\r\n\r\nReload all tables with reload support added and that can be _safe_ reloaded.');
INSERT INTO `command` VALUES ('reload areatrigger_involvedrelation', '10', 'Syntax: .reload areatrigger_involvedrelation\nReload areatrigger_involvedrelation table.');
INSERT INTO `command` VALUES ('reload areatrigger_tavern', '10', 'Syntax: .reload areatrigger_tavern\nReload areatrigger_tavern table.');
INSERT INTO `command` VALUES ('reload areatrigger_teleport', '10', 'Syntax: .reload areatrigger_teleport\nReload areatrigger_teleport table.');
INSERT INTO `command` VALUES ('reload autobroadcast', '10', 'Syntax: .reload autobroadcast\nReload autobroadcast table.');
INSERT INTO `command` VALUES ('reload command', '10', 'Syntax: .reload command\nReload command table.');
INSERT INTO `command` VALUES ('reload config', '10', 'Syntax: .reload config\r\n\r\nReload config settings (by default stored in trinityd.conf). Not all settings can be change at reload: some new setting values will be ignored until restart, some values will applied with delay or only to new objects/maps, some values will explicitly rejected to change at reload.');
INSERT INTO `command` VALUES ('reload creature_questender', '10', 'Syntax: .reload creature_questender\nReload creature_questender table.');
INSERT INTO `command` VALUES ('reload creature_linked_respawn', '9', 'Syntax: .reload creature_linked_respawn\r\nReload creature_linked_respawn table.');
INSERT INTO `command` VALUES ('reload creature_loot_template', '10', 'Syntax: .reload creature_loot_template\nReload creature_loot_template table.');
INSERT INTO `command` VALUES ('reload creature_queststarter', '10', 'Syntax: .reload creature_queststarter\nReload creature_queststarter table.');
INSERT INTO `command` VALUES ('reload disenchant_loot_template', '10', 'Syntax: .reload disenchant_loot_template\nReload disenchant_loot_template table.');
INSERT INTO `command` VALUES ('reload event_scripts', '10', 'Syntax: .reload event_scripts\nReload event_scripts table.');
INSERT INTO `command` VALUES ('reload fishing_loot_template', '10', 'Syntax: .reload fishing_loot_template\nReload fishing_loot_template table.');
INSERT INTO `command` VALUES ('reload game_graveyard_zone', '10', 'Syntax: .reload game_graveyard_zone\nReload game_graveyard_zone table.');
INSERT INTO `command` VALUES ('reload game_tele', '10', 'Syntax: .reload game_tele\nReload game_tele table.');
INSERT INTO `command` VALUES ('reload gameobject_loot_template', '10', 'Syntax: .reload gameobject_loot_template\nReload gameobject_loot_template table.');
INSERT INTO `command` VALUES ('reload gameobject_queststarter', '10', 'Syntax: .reload gameobject_queststarter\nReload gameobject_queststarter table.');
INSERT INTO `command` VALUES ('reload gm_tickets', '10', 'Syntax: .reload gm_tickets\nReload gm_tickets table.');
INSERT INTO `command` VALUES ('reload item_enchantment_template', '10', 'Syntax: .reload item_enchantment_template\nReload item_enchantment_template table.');
INSERT INTO `command` VALUES ('reload item_loot_template', '10', 'Syntax: .reload item_loot_template\nReload item_loot_template table.');
INSERT INTO `command` VALUES ('reload locales_creature', '10', 'Syntax: .reload locales_creature\nReload locales_creature table.');
INSERT INTO `command` VALUES ('reload locales_gameobject', '10', 'Syntax: .reload locales_gameobject\nReload locales_gameobject table.');
INSERT INTO `command` VALUES ('reload locales_item', '10', 'Syntax: .reload locales_item\nReload locales_item table.');
INSERT INTO `command` VALUES ('reload locales_npc_text', '10', 'Syntax: .reload locales_npc_text\nReload locales_npc_text table.');
INSERT INTO `command` VALUES ('reload locales_page_text', '10', 'Syntax: .reload locales_page_text\nReload locales_page_text table.');
INSERT INTO `command` VALUES ('reload locales_points_of_interest', '10', 'Syntax: .reload locales_points_of_interest\nReload locales_point_of_interest table.');
INSERT INTO `command` VALUES ('reload locales_quest', '10', 'Syntax: .reload locales_quest\nReload locales_quest table.');
INSERT INTO `command` VALUES ('reload milling_loot_template', '10', 'Syntax: .reload milling_loot_template\nReload milling_loot_template table.');
INSERT INTO `command` VALUES ('reload npc_trainer', '10', 'Syntax: .reload npc_trainer\nReload npc_trainer table.');
INSERT INTO `command` VALUES ('reload npc_vendor', '10', 'Syntax: .reload npc_vendor\nReload npc_vendor table.');
INSERT INTO `command` VALUES ('reload page_text', '10', 'Syntax: .reload page_text\nReload page_text table.');
INSERT INTO `command` VALUES ('reload pickpocketing_loot_template', '10', 'Syntax: .reload pickpocketing_loot_template\nReload pickpocketing_loot_template table.');
INSERT INTO `command` VALUES ('reload points_of_interest', '10', 'Syntax: .reload points_of_interest\nReload points_of_interest table.');
INSERT INTO `command` VALUES ('reload prospecting_loot_template', '10', 'Syntax: .reload prospecting_loot_template\nReload prospecting_loot_template table.');
...
INSERT INTO `command` VALUES ('reload mail_loot_template', '10', 'Syntax: .reload quest_mail_loot_template\nReload quest_mail_loot_template table.');
INSERT INTO `command` VALUES ('reload quest_template', '10', 'Syntax: .reload quest_template\nReload quest_template table.');
INSERT INTO `command` VALUES ('reload reference_loot_template', '10', 'Syntax: .reload reference_loot_template\nReload reference_loot_template table.');
INSERT INTO `command` VALUES ('reload reserved_name', '10', 'Syntax: .reload reserved_name\nReload reserved_name table.');
INSERT INTO `command` VALUES ('reload skill_discovery_template', '10', 'Syntax: .reload skill_discovery_template\nReload skill_discovery_template table.');
INSERT INTO `command` VALUES ('reload skill_extra_item_template', '10', 'Syntax: .reload skill_extra_item_template\nReload skill_extra_item_template table.');
INSERT INTO `command` VALUES ('reload skill_fishing_base_level', '10', 'Syntax: .reload skill_fishing_base_level\nReload skill_fishing_base_level table.');
INSERT INTO `command` VALUES ('reload skinning_loot_template', '10', 'Syntax: .reload skinning_loot_template\nReload skinning_loot_template table.');
INSERT INTO `command` VALUES ('reload spell_area', '10', 'Syntax: .reload spell_area\nReload spell_area table.');
INSERT INTO `command` VALUES ('reload spell_bonus_data', '10', 'Syntax: .reload spell_bonus_data\nReload spell_bonus_data table.');
INSERT INTO `command` VALUES ('reload disables', '10', 'Syntax: .reload disables\r\nReload disables table.');
INSERT INTO `command` VALUES ('reload spell_group_stack_rules', '10', 'Syntax: .reload spell_group\nReload spell_group_stack_rules table.');
INSERT INTO `command` VALUES ('reload spell_learn_spell', '10', 'Syntax: .reload spell_learn_spell\nReload spell_learn_spell table.');
INSERT INTO `command` VALUES ('reload spell_linked_spell', '10', 'Usage: .reload spell_linked_spell\r\nReloads the spell_linked_spell DB table.');
INSERT INTO `command` VALUES ('reload spell_loot_template', '10', 'Syntax: .reload spell_loot_template\nReload spell_loot_template table.');
INSERT INTO `command` VALUES ('reload spell_pet_auras', '10', 'Syntax: .reload spell_pet_auras\nReload spell_pet_auras table.');
INSERT INTO `command` VALUES ('reload spell_proc_event', '10', 'Syntax: .reload spell_proc_event\nReload spell_proc_event table.');
INSERT INTO `command` VALUES ('reload spell_required', '10', 'Syntax: .reload spell_required\nReload spell_required table.');
INSERT INTO `command` VALUES ('reload item_set_names', '10', 'Syntax: .reload item_set_names\nReload item_set_names table.');
INSERT INTO `command` VALUES ('reload spell_scripts', '10', 'Syntax: .reload spell_scripts\nReload spell_scripts table.');
INSERT INTO `command` VALUES ('reload spell_target_position', '10', 'Syntax: .reload spell_target_position\nReload spell_target_position table.');
INSERT INTO `command` VALUES ('reload spell_threats', '10', 'Syntax: .reload spell_threats\nReload spell_threats table.');
INSERT INTO `command` VALUES ('reload trinity_string', '10', 'Syntax: .reload trinity_string\nReload trinity_string table.');
INSERT INTO `command` VALUES ('reload waypoint_scripts', '10', 'Syntax: .reload waypoint_scripts\nReload waypoint_scripts table.');
INSERT INTO `command` VALUES ('reload', '10', 'Syntax: .reload $subcommand\nType .reload to see the list of possible subcommands or .help reload $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('repairitems', '9', 'Syntax: .repairitems\r\n\r\nRepair all selected player\'s items.');
INSERT INTO `command` VALUES ('reset achievements', '10', 'Syntax: .reset achievements [$playername]\r\n\r\nReset achievements data for selected or named (online or offline) character. Achievements for persistance progress data like completed quests/etc re-filled at reset. Achievements for events like kills/casts/etc will lost.');
INSERT INTO `command` VALUES ('reset all', '10', 'Syntax: .reset all spells\r\n\r\nSyntax: .reset all talents\r\n\r\nRequest reset spells or talents (including talents for all character\'s pets if any) at next login each existed character.');
INSERT INTO `command` VALUES ('reset honor', '10', 'Syntax: .reset honor [Playername]\r\n  Reset all honor data for targeted character.');
INSERT INTO `command` VALUES ('reset level', '10', 'Syntax: .reset level [Playername]\r\n  Reset level to 1 including reset stats and talents.  Equipped items with greater level requirement can be lost.');
INSERT INTO `command` VALUES ('reset spells', '10', 'Syntax: .reset spells [Playername]\r\n  Removes all non-original spells from spellbook.\r\n. Playername can be name of offline character.');
INSERT INTO `command` VALUES ('reset stats', '10', 'Syntax: .reset stats [Playername]\r\n  Resets(recalculate) all stats of the targeted player to their original VALUESat current level.');
INSERT INTO `command` VALUES ('reset talents', '10', 'Syntax: .reset talents [Playername]\r\n  Removes all talents of the targeted player or pet or named player. Playername can be name of offline character. With player talents also will be reset talents for all character\'s pets if any.');
INSERT INTO `command` VALUES ('reset', '10', 'Syntax: .reset $subcommand\nType .reset to see the list of possible subcommands or .help reset $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('respawn', '10', 'Syntax: .respawn\r\n\r\nRespawn all nearest creatures and GO without waiting respawn time expiration.');
INSERT INTO `command` VALUES ('revive', '10', 'Syntax: .revive\r\n\r\nRevive the selected player. If no player is selected, it will revive you.');
INSERT INTO `command` VALUES ('save', '7', 'Syntax: .save\r\n\r\nSaves your character.');
INSERT INTO `command` VALUES ('saveall', '8', 'Syntax: .saveall\r\n\r\nSave all characters in game.');
INSERT INTO `command` VALUES ('send items', '10', 'Syntax: .send items #playername \"#subject\" \"#text\" itemid1[:count1] itemid2[:count2] ... itemidN[:countN]\r\n\r\nSend a mail to a player. Subject and mail text must be in \"\". If for itemid not provided related count values then expected 1, if count > max items in stack then items will be send in required amount stacks. All stacks amount in mail limited to 12.');
INSERT INTO `command` VALUES ('send mail', '8', 'Syntax: .send mail #playername \"#subject\" \"#text\"\r\n\r\nSend a mail to a player. Subject and mail text must be in \"\".');
INSERT INTO `command` VALUES ('send message', '10', 'Syntax: .send message $playername $message\r\n\r\nSend screen message to player from ADMINISTRATOR.');
INSERT INTO `command` VALUES ('send money', '10', 'Syntax: .send money #playername \"#subject\" \"#text\" #money\r\n\r\nSend mail with money to a player. Subject and mail text must be in \"\".');
INSERT INTO `command` VALUES ('server corpses', '9', 'Syntax: .server corpses\r\n\r\nTriggering corpses expire check in world.');
INSERT INTO `command` VALUES ('server exit', '12', 'Syntax: .server exit\r\n\r\nTerminate trinity-core NOW. Exit code 0.');
INSERT INTO `command` VALUES ('server idlerestart cancel', '10', 'Syntax: .server idlerestart cancel\r\n\r\nCancel the restart/shutdown timer if any.');
INSERT INTO `command` VALUES ('server idlerestart', '10', 'Syntax: .server idlerestart #delay\r\n\r\nRestart the server after #delay seconds if no active connections are present (no players). Use #exist_code or 2 as program exist code.');
INSERT INTO `command` VALUES ('server idleshutdown cancel', '10', 'Syntax: .server idleshutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.');
INSERT INTO `command` VALUES ('server idleshutdown', '10', 'Syntax: .server idleshutdown #delay [#exist_code]\r\n\r\nShut the server down after #delay seconds if no active connections are present (no players). Use #exist_code or 0 as program exist code.');
INSERT INTO `command` VALUES ('server info', '7', 'Syntax: .server info\r\n\r\nDisplay server version and the number of connected players.');
INSERT INTO `command` VALUES ('server motd', '7', 'Syntax: .server motd\r\n\r\nShow server Message of the day.');
INSERT INTO `command` VALUES ('server plimit', '10', 'Syntax: .server plimit [#num|-1|-2|-3|reset|player|moderator|gamemaster|administrator]\r\n\r\nWithout arg show current player amount and security level limitations for login to server, with arg set player linit ($num > 0) or securiti limitation ($num < 0 or security leme name. With `reset` sets player limit to the one in the config file');
INSERT INTO `command` VALUES ('server restart cancel', '10', 'Syntax: .server restart cancel\r\n\r\nCancel the restart/shutdown timer if any.');
INSERT INTO `command` VALUES ('server restart', '10', 'Syntax: .server restart #delay\r\n\r\nRestart the server after #delay seconds. Use #exist_code or 2 as program exist code.');
INSERT INTO `command` VALUES ('server set closed', '10', 'Syntax: server set closed on/off\r\n\r\nSets whether the world accepts new client connectsions.');
INSERT INTO `command` VALUES ('server set motd', '10', 'Syntax: .server set motd $MOTD\r\n\r\nSet server Message of the day.');
INSERT INTO `command` VALUES ('server shutdown cancel', '10', 'Syntax: .server shutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.');
INSERT INTO `command` VALUES ('server shutdown', '10', 'Syntax: .server shutdown #delay [#exit_code]\r\n\r\nShut the server down after #delay seconds. Use #exit_code or 0 as program exit code.');
INSERT INTO `command` VALUES ('server', '10', 'Syntax: .server $subcommand\nType .server to see the list of possible subcommands or .help server $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('setskill', '10', 'Syntax: .setskill #skill #level [#max]\r\n\r\nSet a skill of id #skill with a current skill value of #level and a maximum value of #max (or equal current maximum if not provide) for the selected character. If no character is selected, you learn the skill.');
INSERT INTO `command` VALUES ('showarea', '10', 'Syntax: .showarea #areaid\r\n\r\nReveal the area of #areaid to the selected character. If no character is selected, reveal this area to you.');
INSERT INTO `command` VALUES ('unstuck', '7', 'Syntax: .unstuck $playername [inn/graveyard/startzone]\n\nTeleports specified player to specified location. Default location is player\'s current hearth location.');
INSERT INTO `command` VALUES ('cheat god', '0', 'Syntax: .cheat god [on/off]\r\nEnables or disables your character\'s ability to take damage.');
INSERT INTO `command` VALUES ('cheat casttime', '0', 'Syntax: .cheat casttime [on/off]\r\nEnables or disables your character\'s spell cast times.');
INSERT INTO `command` VALUES ('tele add', '10', 'Syntax: .tele add $name\r\n\r\nAdd current your position to .tele command target locations list with name $name.');
INSERT INTO `command` VALUES ('tele del', '10', 'Syntax: .tele del $name\r\n\r\nRemove location with name $name for .tele command locations list.');
INSERT INTO `command` VALUES ('tele group', '8', 'Syntax: .tele group#location\r\n\r\nTeleport a selected player and his group members to a given location.');
INSERT INTO `command` VALUES ('tele name', '8', 'Syntax: .tele name [#playername] #location\n\nTeleport the given character to a given location. Character can be offline.\n\nTo teleport to homebind, set #location to \"$home\" (without quotes).');
INSERT INTO `command` VALUES ('tele', '8', 'Syntax: .tele #location\r\n\r\nTeleport player to a given location.');
INSERT INTO `command` VALUES ('ticket assign', '8', 'Usage: .ticket assign $ticketid $gmname.\r\nAssigns the specified ticket to the specified Game Master.');
INSERT INTO `command` VALUES ('ticket close', '8', 'Usage: .ticket close $ticketid.\r\nCloses the specified ticket. Does not delete permanently.');
INSERT INTO `command` VALUES ('ticket closedlist', '8', 'Displays a list of closed GM tickets.');
INSERT INTO `command` VALUES ('ticket comment', '8', 'Usage: .ticket comment $ticketid $comment.\r\nAllows the adding or modifying of a comment to the specified ticket.');
INSERT INTO `command` VALUES ('ticket delete', '10', 'Usage: .ticket delete $ticketid.\r\nDeletes the specified ticket permanently. Ticket must be closed first.');
INSERT INTO `command` VALUES ('ticket list', '8', 'Displays a list of open GM tickets.');
INSERT INTO `command` VALUES ('ticket onlinelist', '8', 'Displays a list of open GM tickets whose owner is online.');
INSERT INTO `command` VALUES ('ticket unassign', '8', 'Usage: .ticket unassign $ticketid.\r\nUnassigns the specified ticket from the current assigned Game Master.');
INSERT INTO `command` VALUES ('ticket viewid', '8', 'Usage: .ticket viewid $ticketid.\r\nReturns details about specified ticket. Ticket must be open and not deleted.');
INSERT INTO `command` VALUES ('ticket viewname', '8', 'Usage: .ticket viewname $creatorname. \r\nReturns details about specified ticket. Ticket must be open and not deleted.');
INSERT INTO `command` VALUES ('ticket', '8', 'Syntax: .ticket $subcommand\nType .ticket to see the list of possible subcommands or .help ticket $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('unaura', '10', 'Syntax: .unaura #spellid\r\n\r\nRemove aura due to spell #spellid from the selected Unit.');
...
INSERT INTO `command` VALUES ('gobject info', '376', 'Syntax: .gobject info [$object_entry]\r \r Query Gameobject information for selected gameobject or given entry.');
INSERT INTO `command` VALUES ('reload creature_template', '10', 'Syntax: .reload creature_template $entry\r\nReload the specified creature\'s template.');
...
INSERT INTO `command` VALUES ('reload creature_onkill_reputation', '10', 'Syntax: .reload creature_onkill_reputation\r\nReload creature_onkill_reputation table.');
INSERT INTO `command` VALUES ('reload conditions', '10', 'Reload conditions table.');
INSERT INTO `command` VALUES ('reload locales_item_set_name', '10', 'Syntax: .reload locales_item_set_name\nReload locales_item_set_name table.');
...
INSERT INTO `command` VALUES ('reload gossip_menu', '10', 'Syntax: .reload gossip_menu\nReload gossip_menu table.');
INSERT INTO `command` VALUES ('reload gossip_menu_option', '10', 'Syntax: .reload gossip_menu_option\nReload gossip_menu_option table.');
INSERT INTO `command` VALUES ('cast dest', '268', 'Syntax: .cast dest #spellid #x #y #z [triggered]\r\n  Selected target will cast #spellid at provided destination. If \'trigered\' or part provided then spell casted with triggered flag.');
INSERT INTO `command` VALUES ('reload all scripts', '10', 'Syntax: .reload all scripts\nReload gameobject_scripts, event_scripts, quest_end_scripts, quest_start_scripts, spell_scripts, db_script_string, waypoint_scripts tables.');
INSERT INTO `command` VALUES ('reload locales_gossip_menu_option', '10', 'Syntax: .reload locales_gossip_menu_option\nReload locales_gossip_menu_option table.');
INSERT INTO `command` VALUES ('reload quest_poi', '10', 'Syntax: .reload quest_poi\nReload quest_poi table.');
INSERT INTO `command` VALUES ('reload lfg_dungeon_rewards', '10', 'Syntax: .reload lfg_dungeon_rewards\nReload lfg_dungeon_rewards table.');
...
INSERT INTO `command` VALUES ('reload creature_text', '10', 'Syntax: .reload creature_text\r\nReload creature_text table.');
...
INSERT INTO `command` VALUES ('npc set spawndist', '9', 'Syntax: .npc set spawndist #dist\r\n\r\nAdjust spawndistance of selected creature to dist.');
INSERT INTO `command` VALUES ('npc set spawntime', '9', 'Syntax: .npc set spawntime #time \r\n\r\nAdjust spawntime of selected creature to time.');
INSERT INTO `command` VALUES ('npc add temp', '9', 'Syntax: .npc add temp\r\n\r\nAdds temporary NPC, not saved to database.');
INSERT INTO `command` VALUES ('npc textemote', '8', 'Syntax: .npc textemote #emoteid\r\n\r\nMake the selected creature to do textemote with an emote of id #emoteid.');
INSERT INTO `command` VALUES ('npc whisper', '8', 'Syntax: .npc whisper #playerguid #text\r\nMake the selected npc whisper #text to  #playerguid.');
INSERT INTO `command` VALUES ('npc yell', '8', 'Syntax: .npc yell $message\nMake selected creature yell specified message.');
INSERT INTO `command` VALUES ('wp add', '9', 'Syntax: .wp add\r\n\r\nAdd a waypoint for the selected creature at your current position.');
INSERT INTO `command` VALUES ('reload all spell', '10', 'Syntax: .reload all spell\r\n\r\nReload all `spell_*` tables with reload support added and that can be _safe_ reloaded.');
INSERT INTO `command` VALUES ('server set loglevel', '12', 'Syntax: .server set loglevel $facility $name $loglevel. $facility can take the values: appender (a) or logger (l). $loglevel can take the values: disabled (0), trace (1), debug (2), info (3), warn (4), error (5) or fatal (6)');
INSERT INTO `command` VALUES ('reload access_requirement', '10', 'Syntax: .reload access_requirement\nReload access_requirement table.');
INSERT INTO `command` VALUES ('reload achievement_criteria_data', '10', 'Syntax: .reload achievement_criteria_data\nReload achievement_criteria_data table.');
INSERT INTO `command` VALUES ('reload achievement_reward', '10', 'Syntax: .reload achievement_reward\nReload achievement_reward table.');
INSERT INTO `command` VALUES ('reload all achievement', '10', 'Syntax: .reload all achievement\r\n\r\nReload achievement_reward, achievement_criteria_data tables.');
INSERT INTO `command` VALUES ('reload all area', '10', 'Syntax: .reload all area\r\n\r\nReload areatrigger_teleport, areatrigger_tavern, game_graveyard_zone tables.');
INSERT INTO `command` VALUES ('reload all eventai', '10', 'Syntax: .reload all eventai\r\n\r\nReload creature_ai_scripts, creature_ai_summons, creature_ai_texts tables.');
INSERT INTO `command` VALUES ('reload auctions', '10', 'Syntax: .reload auctions\nReload dynamic data tables from the database.');
INSERT INTO `command` VALUES ('reload mail_level_reward', '10', 'Syntax: .reload mail_level_reward\nReload mail_level_reward table.');
INSERT INTO `command` VALUES ('reload smart_scripts', '10', 'Syntax: .reload smart_scripts\nReload smart_scripts table.');
INSERT INTO `command` VALUES ('reload vehicle_accessory', '10', 'Syntax: .reload vehicle_accessory\n\nReloads GUID-based vehicle accessory definitions from the database.');
INSERT INTO `command` VALUES ('reload vehicle_template_accessory', '10', 'Syntax: .reload vehicle_template_accessory\n\nReloads entry-based vehicle accessory definitions from the database.');
INSERT INTO `command` VALUES ('dev', '10', 'Syntax: .dev [on/off]\r\n\r\nEnable or Disable in game Dev tag or show current state if on/off not provided.');
INSERT INTO `command` VALUES ('ticket reset', '10', 'Syntax: .ticket reset\nRemoves all closed tickets and resets the counter, if no pending open tickets are existing.');
INSERT INTO `command` VALUES ('reload waypoint_data', '10', 'Syntax: .reload waypoint_data will reload waypoint_data table.');
INSERT INTO `command` VALUES ('group', '10', 'Syntax: .group $subcommand\nType .group to see the list of possible subcommands or .help group $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('group leader', '10', 'Syntax: .group leader [$characterName]\n\nSets the given character as his group\'s leader.');
INSERT INTO `command` VALUES ('group disband', '10', 'Syntax: .group disband [$characterName]\n\nDisbands the given character\'s group.');
INSERT INTO `command` VALUES ('group remove', '10', 'Syntax: .group remove [$characterName]\n\nRemoves the given character from his group.');
...
INSERT INTO `command` VALUES ('reload locales_creature_text', '10', 'Syntax: .reload locales_creature_text\nReload locales_creature_text Table.');
INSERT INTO `command` VALUES ('morph', '9', 'Syntax: .morph #displayid\r\n\r\nChange your current model id to #displayid.');
INSERT INTO `command` VALUES ('modify arenapoints', '8', 'Syntax: .modify arenapoints #value\r\nAdd $amount arena points to the selected player.');
INSERT INTO `command` VALUES ('npc set data', '10', 'Syntax: .npc set data $field $data\nSets data for the selected creature. Used for testing Scripting');
...
INSERT INTO `command` VALUES ('bf enable', '10', 'Syntax: .bf enable #battleid');
...
INSERT INTO `command` VALUES ('mmap', '10', 'Syntax: Syntax: .mmaps $subcommand Type .mmaps to see the list of possible subcommands or .help mmaps $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('mmap path', '10', 'Syntax: .mmap path to calculate and show a path to current select unit');
INSERT INTO `command` VALUES ('mmap loc', '10', 'Syntax: .mmap loc to print on which tile one is');
INSERT INTO `command` VALUES ('mmap loadedtiles', '10', 'Syntax: .mmap loadedtiles to show which tiles are currently loaded');
INSERT INTO `command` VALUES ('mmap stats', '10', 'Syntax: .mmap stats to show information about current state of mmaps');
INSERT INTO `command` VALUES ('mmap testarea', '10', 'Syntax: .mmap testarea to calculate paths for all nearby npcs to player');
...
INSERT INTO `command` VALUES ('group join', '10', 'Syntax: .group join $AnyCharacterNameFromGroup [$CharacterName] \r\nAdds to group of player $AnyCharacterNameFromGroup player $CharacterName (or selected).');
INSERT INTO `command` VALUES ('group list', '10', 'Syntax: .group list [$CharacterName] \r\nLists all the members of the group/party the player is in.');
INSERT INTO `command` VALUES ('rbac account', '10', 'Syntax: .rbac account [$account]\n\nView permissions of selected player or given account\nNote: Only those that affect current realm\n\nNote: Shows real permissions after checking group and roles');
INSERT INTO `command` VALUES ('rbac account group', '10', 'Syntax: .rbac account group [$account]\n\nView groups of selected player or given account\nNote: Only those that affect current realm');
INSERT INTO `command` VALUES ('rbac account group add', '10', 'Syntax: .rbac account group add [$account] #id [#realmId]\n\nAdd a group to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account group remove', '10', 'Syntax: .rbac account group remove [$account] #id\n\nRemove a group from selected player or given account.');
INSERT INTO `command` VALUES ('rbac account role', '10', 'Syntax: .rbac account role [$account]\n\nView roles of selected player or given account\nNote: Only those that affect current realm\nNote: Only those directly granted or denied, does not include inherited roles from groups');
INSERT INTO `command` VALUES ('rbac account role grant', '10', 'Syntax: .rbac account role grant [$account] #id [#realmId]\n\nGrant a role to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account role deny', '10', 'Syntax: .rbac account role deny [$account] #id [#realmId]\n\nDeny a role to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account role revoke', '10', 'Syntax: .rbac account role revoke [$account] #id\n\nRemove a role from an account\n\nNote: Removes the role from granted or denied roles');
INSERT INTO `command` VALUES ('rbac account permission', '10', 'Syntax: .rbac account permission [$account]\n\nView permissions of selected player or given account\nNote: Only those that affect current realm\nNote: Only those directly granted or denied, does not include inherited permissions from roles');
INSERT INTO `command` VALUES ('rbac account permission grant', '10', 'Syntax: .rbac account permission grant [$account] #id [#realmId]\n\nGrant a permission to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account permission deny', '10', 'Syntax: .rbac account permission deny [$account] #id [#realmId]\n\nDeny a permission to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account permission revoke', '10', 'Syntax: .rbac account permission revoke [$account] #id\n\nRemove a permission from an account\n\nNote: Removes the permission from granted or denied permissions');
INSERT INTO `command` VALUES ('rbac list groups', '10', 'Syntax: .rbac list groups [$id]\n\nView list of all groups. If $id is given will show group info and his inherited roles.');
INSERT INTO `command` VALUES ('rbac list roles', '10', 'Syntax: .rbac list roles [$id]\n\nView list of all roles. If $id is given will show role info and his inherited permissions.');
INSERT INTO `command` VALUES ('rbac list permissions', '10', 'Syntax: .rbac list permissions [$id]\n\nView list of all permissions. If $id is given will show only info for that permission.');
INSERT INTO `command` VALUES ('reload creature_summon_groups', '10', 'Syntax: .reload creature_summon_groups\nReload creature_summon_groups table.');
INSERT INTO `command` VALUES ('reload rbac', '10', 'Syntax: .reload rbac\nReload rbac system.');
...
INSERT INTO `command` VALUES ('reload gameobject_questender', '10', 'Syntax: .reload gameobject_questender\\nReload gameobject_questender table.');
INSERT INTO `command` VALUES ('account email', '0', 'Syntax: .account email $oldemail $currentpassword $newemail $newemailconfirmation\r\n\r\n Change your account email. You may need to check the actual security mode to see if email input is necessary for password change');
INSERT INTO `command` VALUES ('account set sec email', '3', 'Syntax: .account set sec email $accountname $email $emailconfirmation\r\n\r\nSet the email for entered player account.');
INSERT INTO `command` VALUES ('account set sec regmail', '4', 'Syntax: .account set sec regmail $account $regmail $regmailconfirmation\r\n\r\nSets the regmail for entered player account.');
INSERT INTO `command` VALUES ('npcbot add', '7', null);
INSERT INTO `command` VALUES ('npcbot info', '7', null);
INSERT INTO `command` VALUES ('npcbot fuhuo', '7', null);
INSERT INTO `command` VALUES ('npcbot shan', '7', null);
INSERT INTO `command` VALUES ('npcbot shuaxin', '7', null);
INSERT INTO `command` VALUES ('npcbot command', '7', null);
